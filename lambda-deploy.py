...
api_conf_html = {
  ...
  #"host" : "ig768nnnnn.execute-api.eu-west-1.amazonaws.com",
  "basePath" : "/prod",
  "schemes" : [ "https" ],
  "paths" : {
    "/" : {
...
api_conf_json = {
  ...
  #"host" : "11b7281xxx.execute-api.eu-west-1.amazonaws.com",
  "basePath" : "/prod",
  "schemes" : [ "https" ],
  "paths" : {
    "/" : {
...
plain_api_conf = {
  ...
  "host" : "11b72819xa.execute-api.eu-west-1.amazonaws.com",
  "basePath" : "/prod",
  "schemes" : [ "https" ],
  "paths" : {
    "/" : {
